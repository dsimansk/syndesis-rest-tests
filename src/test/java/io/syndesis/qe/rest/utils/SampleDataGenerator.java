...
public final class SampleDataGenerator {
	...
	public static Integration createSampleIntegration(String name) {
		return createSampleIntegration(name, Optional.empty(), Optional.empty());
	}

	public static Integration createSampleIntegration(String name, Optional<String> id, Optional<String> token) {
